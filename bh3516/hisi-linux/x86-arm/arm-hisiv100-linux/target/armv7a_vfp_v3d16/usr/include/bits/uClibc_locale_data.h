...
#define __lc_monetary_data_LEN		1620
#define __lc_monetary_rows_LEN		3740
#define __lc_monetary_item_offsets_LEN		22
#define __lc_monetary_item_idx_LEN		399
