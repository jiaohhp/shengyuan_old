...
typedef enum hiVENC_RC_MODE_E
{
    ...
    VENC_RC_MODE_H264ABR          = 3,        
    VENC_RC_MODE_H264FIXQP        = 4,      
    
    VENC_RC_MODE_MJPEGCBR         = 5,    
    VENC_RC_MODE_MJPEGVBR         = 6,        
    VENC_RC_MODE_MJPEGABR         = 7,        
    VENC_RC_MODE_MJPEGFIXQP       = 8,  

    VENC_RC_MODE_MPEG4CBR         = 9,    
    VENC_RC_MODE_MPEG4VBR         = 10,        
    VENC_RC_MODE_MPEG4ABR         = 11,        
    VENC_RC_MODE_MPEG4FIXQP       = 12,  
...
{
    SUPERFRM_NONE          = 1,                /* sdk don't care super frame */
    SUPERFRM_DISCARD       = 2,             /* the super frame is discarded */
    SUPERFRM_REENCODE      = 3,            /* the super frame is re-encode */
    SUPERFRM_BUTT
...
{     
    HI_U32	u32Thrd[12];                    /* just useful for h264 and mpeg4 for now */
    HI_U32	u32QpDelta;		
    union
    {
